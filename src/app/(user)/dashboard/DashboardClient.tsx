      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-neutral-950 via-neutral-950/90 to-transparent z-40">
        <div className="w-full max-w-lg mx-auto block">
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 bg-green-500 text-black font-black text-[15px] tracking-wide py-4 rounded-xl hover:bg-green-400 transition-all shadow-[0_0_25px_rgba(34,197,94,0.25)] active:scale-[0.98]"
          >
