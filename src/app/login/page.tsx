    ...
    <div className="w-full max-w-[420px] relative z-10 animate-in fade-in zoom-in-[0.98] duration-700">
      ...
      <div className="bg-neutral-900/60 backdrop-blur-2xl border border-white/5 rounded-[2rem] p-6 sm:p-8 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {successMsg && (
            <div className="bg-green-500/10 border border-green-500/20 text-green-500 text-sm font-bold p-4 rounded-2xl flex items-start gap-3">
              <svg className="w-5 h-5 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
              {successMsg}
            </div>
          )}
